...
<body>
	<div class="cont uPost" data-toggle="modal" data-target="#myModal" data-id="${userId}">
			<p><i class="material-icons" style="font-size:30px">playlist_add</i></p>
			<h6>Upload New Post</h6>
	</div>
	<br><br><br>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="btm" enctype="multipart/form-data" action="uploadPost" method="post">
						<br>
						<label for="Upload">Upload Data : </label>
						<input class="file" type="file" name="da" accept="image/*"><br>
